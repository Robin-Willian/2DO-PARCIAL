...
public class Login extends BaseWindow {
    ...
    private void createTextField() {
        this.userNameTextField = new TextFieldComponent(this.lang.getI18nText(TextCodes.userNameTextField),
                this.rightPanel);
        this.userNameTextField.setPosition(40);
        this.rightPanel.add(this.userNameTextField);

        this.lastNameTextField = new TextFieldComponent(this.lang.getI18nText(TextCodes.lastNameTextField),
                this.rightPanel);
    ...
    private void createButton() {
        ...
        this.button.addActionListener(e -> {
            this.getListener().onEvent("click-login", e); 
        });
    }
